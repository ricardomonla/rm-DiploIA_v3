...
import './rmVerticalScrubber.css';

const RmVerticalScrubber = ({
  annotations,
  currentTime,
  duration,
  onSeek,
  ...
  const findNearestAnnotation = React.useCallback((position) => {
  ...
  const updatePosition = React.useCallback((e) => {
  ...
  }, [isDragging, dragPosition, duration, onSeek, findNearestAnnotation]);
  ...
  // Update tooltip position based on current time
  useEffect(() => {
...
export default RmVerticalScrubber;